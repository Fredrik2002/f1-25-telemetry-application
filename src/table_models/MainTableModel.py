...
class MainTableModel(QAbstractTableModel):
    def __init__(self, parent):
        super().__init__()
        self._data = [player.main_tab() for player in PLAYERS_LIST if player.position != 0]
        self._header = ["Pos", "Driver", "Tyres", "Tyres\nAge", "Gap\n(Leader)",
        ...
        self.column_sizes = [4, 15, 8, 8, 10, 5, 10, 10, 10, 5, 5]
