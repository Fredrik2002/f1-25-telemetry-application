...
class LapTableModel(QAbstractTableModel):
    def __init__(self, parent):
        super().__init__()
        self._data = [player.lap_tab() for player in PLAYERS_LIST if player.position != 0]
        self._header = ["Pos", "Driver", "Tyres", "Current Lap", "Last Lap", "Fastest Lap"]
        ...
        self.column_sizes = [4, 15, 8, 25, 25, 25]
