...
class ERSAndFuelTableModel(QAbstractTableModel):
    def __init__(self, parent):
        super().__init__()
        self._data = [player.ers_and_fuel_tab() for player in PLAYERS_LIST if player.position != 0]
        self._header = ["Pos", "Driver", "Tyres", "ERS", "ERS Mode", "Fuel", "Fuel Mix"]
        ...
        self.column_sizes = [4, 15, 8, 8, 10, 10, 10]
    ...
    def create_table(self, parent):
        ...
        parent.tabs.addTab(tab, "ERS & Fuel")
