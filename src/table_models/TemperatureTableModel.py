...
class TemperatureTableModel(QAbstractTableModel):
    def __init__(self, parent):
        super().__init__()
        self._data = [player.temperature_tab() for player in PLAYERS_LIST if player.position != 0]
        self._header = ["Pos", "Driver", "Tyres", "Tyres Surface\nTemperatures",
                         "Tyres Inner\nTemperatures"]
        ...
        self.column_sizes = [8, 15, 8, 12, 12]
    ...
    def create_table(self, parent):
        ...
        parent.tabs.addTab(tab, "Temperatures")
